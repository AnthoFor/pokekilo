...
fetchApi = async () => {
    for (let index = 1; index <= 32; index++) {
        ...
        pokeIco = data1.sprites.versions["generation-vii"].icons.front_default;
        let pokeName = data2.names[4].name;
        pokeCatalog.push({
            name:pokeName,
            id:pokeId,
            type:pokeType,
            desc:pokeDescription,
            price:pokePrice,
            sprite:imgPoke,
            weight:pokeWeight,
            icons:pokeIco
        ...
        //             <li class="list-group-item bg-danger pokeDesc">${pokeDescription}</li>
        ...
        //             <li class="list-group-item bg-danger"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi  bi-cart-plus-fill my-2 mx-auto cartAdd data-poke="${pokeName}" viewBox="0 0 16 16">
...
printPokeCard = () =>{
    if (filteredResults.length > 0) {
        ...
        <article class="col col-md-6 col-lg-3 d-flex justify-content-center flex-column my-4 ">
            <div class="card bg-danger text-center mx-auto">
                <img src="${element.sprite}" class="card-img-top" alt="${element.name} picture">
                <div class="card-body">
                    <h5 class="card-title">${element.name}</h5>
                    
                </div>
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-danger"><img src="public/assets/img/${element.type}.png" alt="${element.type} picture"></li>
                    <li class="list-group-item bg-danger pokeDesc">${element.desc}</li>
                    <li class="list-group-item bg-danger">Poids : ${element.weight}kg</li>
                    <li class="list-group-item bg-danger">Pokédex N° : ${element.id}</li>
                    <li class="list-group-item bg-danger">Prix : ${element.price}₽</li>
                    <li class="list-group-item bg-danger">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" class="bi  bi-cart-plus-fill my-2 mx-auto cartAdd" data-pokeName="${element.name}" data-pokeId="${element.id}" data-pokeimg="${element.sprite}" data-pokeprice="${element.price}" data-pokeico="${element.icons}" viewBox="0 0 16 16">
                    <path d="M.5 1a.5.5 0 0 0 0 1h1.11l.401 1.607 1.498 7.985A.5.5 0 0 0 4 12h1a2 2 0 1 0 0 4 2 2 0 0 0 0-4h7a2 2 0 1 0 0 4 2 2 0 0 0 0-4h1a.5.5 0 0 0 .491-.408l1.5-8A.5.5 0 0 0 14.5 3H2.89l-.405-1.621A.5.5 0 0 0 2 1H.5zM6 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm7 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zM9 5.5V7h1.5a.5.5 0 0 1 0 1H9v1.5a.5.5 0 0 1-1 0V8H6.5a.5.5 0 0 1 0-1H8V5.5a.5.5 0 0 1 1 0z"/>
                </svg></li>
                </ul>
            </div>
